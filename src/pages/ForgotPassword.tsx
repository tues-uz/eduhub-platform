            ...
            <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-lg border-2 border-gray-200 p-8">
              {isSuccess ? (
                <div className="text-center space-y-6">
                  ...
                  <p className="text-foreground/60 text-xs">{t("auth.forgotPassword.successHint")}</p>
                  <div className="space-y-3">
                    ...
                    <Button
                      ...
                      asChild
                    >
                      <Link to={appRoutes.signIn}>{t("auth.forgotPassword.backToSignIn")}</Link>
                    </Button>
                  </div>
                </div>
              ) : (
                <>
                  <div className="text-center mb-8">
                    ...
                    <p className="text-foreground/70 text-sm">{t("auth.forgotPassword.subtitle")}</p>
                  </div>
