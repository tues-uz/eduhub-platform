...
import { resolveTeacherBreadcrumb } from "@/features/layout/resolveTeacherPageHeader";
...
/**
 * Shared shell for all teacher dashboard routes: light sidebar, sticky top header, page outlet.
 */
export default function TeacherDashboardLayout() {
  ...
  const breadcrumb = resolveTeacherBreadcrumb(pathname, t);
          ...
          <div className="flex min-w-0 flex-1 items-center gap-2 px-4">
            ...
            <nav aria-label="breadcrumb" className="min-w-0">
              <ol className="flex flex-wrap items-center gap-1.5 text-sm text-muted-foreground">
                ...
                {pathname.replace(/\/+$/, "") !== "/dashboard/teacher" ? (
                  <>
