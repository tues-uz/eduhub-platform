...
/** Mock payroll rows keyed to this email when no payments match the signed-in teacher (demo). */
export const DEMO_TEACHER_PAYROLL_EMAIL = "demo@eduhub.com";
...
export const mockAdminPayments: AdminPaymentRow[] = [
  ...
  /** Default signed-in teacher (`demo@eduhub.com` / Demo User) — drives Payroll “real” demo totals. */
  {
    id: "p-demo-ge-1",
    className: "GE-A2 Morning",
    studentName: "Dilnoza Karimova",
    studentEmail: "dilnoza@example.com",
    course: "General English A2",
    lecturerName: "Demo User",
    lecturerEmail: DEMO_TEACHER_PAYROLL_EMAIL,
    amount: 1_480_000,
    currency: "UZS",
    dueDate: "2026-04-01",
    status: "paid",
    proofSubmitted: true,
    reference: "INV-2026-GE-A2-0101",
    paymentMethod: "Bank transfer",
  ...
  },
  {
    ...
    studentEmail: "aziza.r@example.com",
    course: "General English A2",
    lecturerName: "Demo User",
    lecturerEmail: DEMO_TEACHER_PAYROLL_EMAIL,
    amount: 1_480_000,
    ...
    status: "overdue",
    proofSubmitted: false,
    reference: "INV-2026-GE-A2-0104",
    paymentMethod: "—",
    createdAt: "2026-02-08",
  },
  {
    id: "p-demo-be-1",
    className: "BE-B2 Lunch cohort",
    studentName: "Dilnoza Karimova",
    studentEmail: "dilnoza@example.com",
    course: "Business English B2",
    lecturerName: "Demo User",
  ...
  },
  {
    id: "p-demo-be-2",
    className: "BE-B2 Lunch cohort",
    studentName: "Bobur Saidov",
    studentEmail: "bobur.saidov@example.com",
    course: "Business English B2",
    lecturerName: "Demo User",
    lecturerEmail: DEMO_TEACHER_PAYROLL_EMAIL,
    amount: 2_200_000,
  ...
  },
  {
    id: "p-demo-be-3",
    className: "BE-B2 Lunch cohort",
    studentName: "Nilufar Ergasheva",
    studentEmail: "nilufar.e@example.com",
    course: "Business English B2",
    lecturerName: "Demo User",
    lecturerEmail: DEMO_TEACHER_PAYROLL_EMAIL,
    amount: 2_200_000,
  ...
  },
  {
    id: "p-demo-ielts-2",
    className: "IELTS Weekend",
    studentName: "Shahzod Mirzayev",
    studentEmail: "shahzod.m@example.com",
    course: "IELTS Intensive",
    lecturerName: "Demo User",
    lecturerEmail: DEMO_TEACHER_PAYROLL_EMAIL,
    amount: 3_100_000,
