...
export function SubstituteInviteRequestSummary({
  ...
  const sessionLine = rec.sessionNote?.trim() || "—";
  ...
  return (
    <div className={compact ? "space-y-3" : "space-y-4"}>
      <div>
        <p className="text-[11px] font-semibold uppercase tracking-wide text-foreground/45">Course</p>
        <p
      ...
      <div className={`grid sm:grid-cols-2 ${compact ? "gap-3" : "gap-4"}`}>
        <div>
          <p className="text-[11px] font-semibold uppercase tracking-wide text-foreground/45">From</p>
          <p className="mt-1 text-sm font-medium text-foreground/90">{inviterLine}</p>
        </div>
        <div>
          <p className="text-[11px] font-semibold uppercase tracking-wide text-foreground/45">Session / date</p>
      ...
      {showInvitedSubstitute ? (
        <div className="rounded-lg border border-slate-200/90 bg-white px-3 py-2.5 sm:px-3.5">
          <p className="text-[11px] font-semibold uppercase tracking-wide text-foreground/50">Invited substitute</p>
      ...
      {note ? (
        <div className="rounded-lg border border-slate-200/80 bg-slate-50/90 px-3 py-2.5 sm:px-4">
          <p className="text-[11px] font-semibold uppercase tracking-wide text-foreground/50">Their note</p>
